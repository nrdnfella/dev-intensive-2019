...
object Utils {
    ...
    private val translitMap = mapOf<String,String>("а" to "a", "б" to "b","в" to "v", "г" to "g", "д" to "d", "е" to "e", "ё" to "e", "ж" to "zh", "з" to "z", "и" to "i",
    ...
    fun toInitials(firstName: String?, lastName: String?): String? {
        ...
        return if (initials?.length == 0) null else initials
    }
}